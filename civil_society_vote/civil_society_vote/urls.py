...
urlpatterns = i18n_patterns(
    ...
    path(
        "contact/", StaticPageView.as_view(template_name="contact.html"), name="contact"
    ),
    path(
        "terms/",
    ...
    path(
        "cookies/", StaticPageView.as_view(template_name="cookies.html"), name="cookies"
    ),
    path(
        "updates/", StaticPageView.as_view(template_name="updates.html"), name="updates"
    ),
